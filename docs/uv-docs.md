...
For PDF builds, see also [`tectonic-docs.yml`](tectonic-docs.md), which compiles with Tectonic
instead of installing a TeX Live toolchain through apt. Both workflows are maintained.
